  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-indigo-50 via-blue-50 to-purple-50 relative overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        <div className="absolute -bottom-40 -left-40 w-80 h-80 bg-blue-300 rounded-full mix-blend-multiply filter blur-xl opacity-30"></div>
      </div>
      ...
      <div className="relative z-10 max-w-6xl mx-auto p-8">
        ...
        <div className="grid md:grid-cols-2 gap-8 mb-12">
          ...
          <div className="group relative">
            <div className="bg-white/90 backdrop-blur-sm rounded-2xl shadow-xl p-8 transition-all duration-300 border-2 border-gray-100 hover:border-blue-200 hover:shadow-2xl relative overflow-hidden">
              {/* 호버 효과 */}
              ...
              <div className="relative z-10">
                ...
                <div className="mb-6">
                  ...
                  <div className="grid grid-cols-2 gap-2 text-xs">
                    {['gm', 'Vth', 'μFE', 'SS', 'Ion/Ioff', 'Ron'].map((param) => (
                      <span 
                        key={param}
                        className="bg-blue-50 text-blue-700 px-2 py-1 rounded hover:bg-blue-100 transition-colors text-center"
                      >
                        {param}
                      </span>
                    ))}
          ...
          {/* 통합 분석 버전 */}
          <div className="group relative">
            <div className="bg-white/90 backdrop-blur-sm rounded-2xl shadow-xl p-8 transition-all duration-300 border-2 border-purple-200 hover:border-purple-300 relative overflow-hidden">
              {/* 추천 배지 */}
              ...
              {/* 호버 효과 */}
              <div className="absolute inset-0 bg-gradient-to-br from-purple-50/50 to-pink-100/50 opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
              ...
              <div className="relative z-10">
                ...
                <div className="mb-6">
                  ...
                  <div className="grid grid-cols-2 gap-2 text-xs">
                    {['μFE (통합)', 'μeff (정확)', 'θ (실측)', 'Dit (계산)', '품질등급', '경고시스템'].map((param) => (
                      <span 
                        key={param}
                        className="bg-gradient-to-r from-purple-50 to-pink-50 text-purple-700 px-2 py-1 rounded hover:from-purple-100 hover:to-pink-100 transition-colors text-center"
                      >
                        {param}
                      </span>
                    ))}
        ...
        {/* 사용 가이드 */}
        <div className="grid md:grid-cols-2 gap-8 mb-12">
          <div className="bg-blue-50/80 backdrop-blur-sm rounded-xl p-6 border border-blue-100/50 hover:shadow-xl transition-all duration-300">
          ...
          <div className="bg-purple-50/80 backdrop-blur-sm rounded-xl p-6 border border-purple-100/50 hover:shadow-xl transition-all duration-300">
